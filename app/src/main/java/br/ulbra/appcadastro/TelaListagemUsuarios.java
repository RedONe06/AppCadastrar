...
//Antes de carregar a tela, verifica se existe registros
        ...
        act.setContentView(R.layout.visualizacaodedados);
        ...
        txtnome = (TextView) act.findViewById(R.id.txtNomeResultado);
        txtendereco = (TextView) act.findViewById(R.id.txtEnderecoResultado);
        txttelefone = (TextView) act.findViewById(R.id.txtTelefoneResultado);
        txtstatus = (TextView) act.findViewById(R.id.txtRegistros);
